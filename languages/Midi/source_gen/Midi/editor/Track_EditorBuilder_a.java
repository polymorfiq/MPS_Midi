...
/*package*/ class Track_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new eventsListHandler_97q2ds_a2a(myNode, getEditorContext());
  ...
  private static class eventsListHandler_97q2ds_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public eventsListHandler_97q2ds_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(eventsListHandler_97q2ds_a2a.this.getNode(), LINKS.events$fAV3));
      try {
