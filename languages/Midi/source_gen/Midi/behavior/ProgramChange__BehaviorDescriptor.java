...
public final class ProgramChange__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef7567ae9a7L, "Midi.structure.ProgramChange");
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte channelNum = (byte) (SPropertyOperations.getInteger(__thisNode__, PROPS.channel$gK6u) & 0b00001111);
    bytes[i] = (byte) (0b11000000 | channelNum);
    i += 1;

    byte controller = (byte) ((byte) SPropertyOperations.getInteger(__thisNode__, PROPS.program_number$zX6s) & 0b01111111);
    System.arraycopy(new byte[]{controller}, 0, bytes, i, 1);

    return bytes;
  }

  /*package*/ ProgramChange__BehaviorDescriptor() {
  }
