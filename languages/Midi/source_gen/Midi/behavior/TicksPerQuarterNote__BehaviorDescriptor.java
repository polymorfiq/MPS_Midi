...
public final class TicksPerQuarterNote__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef75678a56bL, "Midi.structure.TicksPerQuarterNote");
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    byte highByte = (byte) ((SPropertyOperations.getInteger(__thisNode__, PROPS.ticks$MMGO) >> 8) & 0b01111111);
    byte lowByte = (byte) (SPropertyOperations.getInteger(__thisNode__, PROPS.ticks$MMGO) & 0b11111111);

    return new byte[]{highByte, lowByte};
  }

  /*package*/ TicksPerQuarterNote__BehaviorDescriptor() {
  }
