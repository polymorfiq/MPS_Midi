...
public final class TimeSignature__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef756e3c574L, "Midi.structure.TimeSignature");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SPropertyOperations.assign(__thisNode__, PROPS.typecode$tQHU, 0x58);
  }
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte nn = (byte) SPropertyOperations.getInteger(__thisNode__, PROPS.numerator$mlAp);
  ...
  /*package*/ TimeSignature__BehaviorDescriptor() {
  }
