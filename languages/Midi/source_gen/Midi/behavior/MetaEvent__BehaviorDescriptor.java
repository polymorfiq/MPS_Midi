...
public final class MetaEvent__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef7567ae942L, "Midi.structure.MetaEvent");
  ...
  /*package*/ static int byte_size_id7K_nJtmDrJf(@NotNull SNode __thisNode__) {
    ...
    byte[] lenBytes = BinaryHelper.variableLengthQuantity(SPropertyOperations.getString(__thisNode__, PROPS.data$dIXu).length());
    return 2 + deltaBytes.length + lenBytes.length + SPropertyOperations.getString(__thisNode__, PROPS.data$dIXu).getBytes().length;
  }
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte[] dataBytes = SPropertyOperations.getString(__thisNode__, PROPS.data$dIXu).getBytes();
    System.arraycopy(dataBytes, 0, bytes, i, dataBytes.length);

    return bytes;
  }

  /*package*/ MetaEvent__BehaviorDescriptor() {
  }
