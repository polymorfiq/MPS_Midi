...
public final class NoteOn__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef7567ae96fL, "Midi.structure.NoteOn");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SLinkOperations.setTarget(__thisNode__, LINKS.velocity$zlWL, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef7567ae964L, "Midi.structure.VelocityValue")));
  }
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte channelNum = (byte) (SPropertyOperations.getInteger(__thisNode__, PROPS.channel$1Joc) & 0b00001111);
    bytes[i] = (byte) (0b10010000 | channelNum);
    i += 1;

    byte keyNumber = (byte) ((byte) (int) Keyable__BehaviorDescriptor.note_number_id7K_nJtmx2Jg.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.key$zlHK)) & 0b01111111);
    System.arraycopy(new byte[]{keyNumber}, 0, bytes, i, 1);
    i += 1;

    byte velocity = (byte) ((byte) (int) Velocityable__BehaviorDescriptor.velocity_id7K_nJtmYbVi.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.velocity$zlWL)) & 0b01111111);
    System.arraycopy(new byte[]{velocity}, 0, bytes, i, 1);

    return bytes;
  }

  /*package*/ NoteOn__BehaviorDescriptor() {
  }
