...
public final class EndOfTrack__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef756e30ce1L, "Midi.structure.EndOfTrack");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SPropertyOperations.assign(__thisNode__, PROPS.typecode$tQHU, 0x2F);
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte emptyByte = 0;
    System.arraycopy(new byte[]{emptyByte}, 0, bytes, i, 1);

    return bytes;
  }

  /*package*/ EndOfTrack__BehaviorDescriptor() {
  }
