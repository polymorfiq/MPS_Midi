...
public final class PolyphonicKeyPressure__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x35a3fd90d0264551L, 0xaa863ed1bd51d7c6L, 0x7c255ef7567ae974L, "Midi.structure.PolyphonicKeyPressure");
  ...
  /*package*/ static byte[] bytes_id7K_nJtmDrGV(@NotNull SNode __thisNode__) {
    ...
    byte channelNum = (byte) (SPropertyOperations.getInteger(__thisNode__, PROPS.channel$aOoQ) & 0b00001111);
    bytes[i] = (byte) (0b10100000 | channelNum);
    i += 1;

    byte keyNumber = (byte) ((byte) (int) Keyable__BehaviorDescriptor.note_number_id7K_nJtmx2Jg.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.key$zn5r)) & 0b01111111);
    System.arraycopy(new byte[]{keyNumber}, 0, bytes, i, 1);
    i += 1;

    byte pressure = (byte) ((byte) (int) Pressurable__BehaviorDescriptor.pressure_id7K_nJtmYvdp.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.pressure$znks)) & 0b01111111);
    System.arraycopy(new byte[]{pressure}, 0, bytes, i, 1);

    return bytes;
  }

  /*package*/ PolyphonicKeyPressure__BehaviorDescriptor() {
  }
